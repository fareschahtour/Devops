package tn.esprit.spring.devops_project.services;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import tn.esprit.spring.devops_project.entities.Invoice;
import tn.esprit.spring.devops_project.entities.Operator;
import tn.esprit.spring.devops_project.entities.Supplier;
import tn.esprit.spring.devops_project.repositories.InvoiceDetailRepository;
import tn.esprit.spring.devops_project.repositories.InvoiceRepository;
import tn.esprit.spring.devops_project.repositories.OperatorRepository;
import tn.esprit.spring.devops_project.repositories.SupplierRepository;
import tn.esprit.spring.devops_project.services.Iservices.IInvoiceService;
